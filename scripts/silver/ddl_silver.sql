...
===============================================================================
Run this script to define the structure of the Silver layer.
===============================================================================
*/

-- 1. Create crm_cust_info
...
SELECT 
    ...
    cst_gndr, 
    cst_marital_status,
    dwh_create_date -- This shows when the record was loaded into Silver
